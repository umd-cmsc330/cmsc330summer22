...
Implement the following functions using recursion. Using a recursive helper fucntion is allowed in which case the main function might not be recursive itself.
